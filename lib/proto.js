...
/**
 * @name init
 * @description Loads and processes the input files and creates the chart object
...
/**
 * @name values
 * @description equiv. Object.values(this)
 * @return {array} values Returns a list of property values
 * @author Andy Willis
 */
 ...
 * @return {integer} sum Sum of the values
 * @author Andy Willis
 */
...
/**
 * @name sortValues
 * @description Orders the words ascending or descending
 * @param {string} direction Ascending or descending
 * @return {object} this The reordered object
 * @author Andy Willis
 */
...
/**
 * @name render
 * @description Produces the chart
...
/**
 * @name processWorkingData
 * @description Takes a list of words, one word per line, and kicks them into a regex-type OR-string.
 * @param {string} commonWords List of commonwords to be removed
 * @param {string} exceptions List of exceptions to be removed
 * @param {string} workingData The raw data
 * @param {string} range Minimum characters per word
 * @param {string} stem Stemmer?
 * @param {string} limit Minimum limit of results
 * @return {object} chartObject A deduped object of words and their values
 * @author Andy Willis
 */
